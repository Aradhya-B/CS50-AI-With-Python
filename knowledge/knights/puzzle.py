...
knowledge3 = And(
    ...
    Implication(BKnight, And(And(Implication(AKnight, AKnave), Implication(AKnave, AKnight)), CKnave)),
    Implication(BKnave, And(And(Implication(AKnight, AKnight), Implication(AKnave, AKnave)), CKnight)),
